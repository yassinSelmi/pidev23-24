...
class LogementController extends AbstractController
{
    ...
    #[Route('/affichageback', name: 'app_logement_indexx', methods: ['GET'])]
    public function indexx(LogementRepository $logementRepository): Response
    {
        return $this->render('logement/indexx.html.twig', [
            'logements' => $logementRepository->findAll(),
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $logement->setImage('uploads/images/'.$fileName);
