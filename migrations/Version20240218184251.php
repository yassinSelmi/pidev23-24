 ...
 */
final class Version20240218184251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_event ADD nom_id INT DEFAULT NULL, ADD nbr_personnes INT NOT NULL, ADD evenement_id INT NOT NULL, CHANGE nbrpersonnes id_client INT NOT NULL, CHANGE nom nom_client VARCHAR(255) NOT NULL');
